...
<div class="wrapper">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-widget">
              ...
              <div class="card-body">
                ...
                <img class="img-fluid pad" src="admin/images/<?php echo $result[0]['image'] ?>" style="height: 200px !important;"  alt="">
  ...
  <footer class="main-footer" style="margin-left: 0px !important;">
    ...
    <div class="float-right d-none d-sm-inline">
     <a href="login.php" type="button" class="btn btn-default" value="">Logout</a>
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2026 <a href="#">A Programmer</a>.</strong> All rights reserved.
  </footer>
